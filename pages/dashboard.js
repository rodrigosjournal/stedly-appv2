  ...
  return (
    <div className="min-h-screen bg-black text-white px-4 py-6">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div>
          <h1 className="text-3xl font-bold mb-6 text-center lg:text-left">Activity Tracker</h1>

          {lastWorkout && (
            <div className="mb-6 p-4 rounded-xl bg-gray-800 border-l-4 border-green-500 shadow">
